...
namespace luval.data
{
    ...
    {
        /// <summary>
        /// Creates a new instance of the <see cref="SqlDatabase" class with the provided connection string/>
        /// </summary>
        /// <param name="connectionString">The parameters to create the Sql Server connection</param>
        public SqlDatabase(string connectionString) : base((() => { return new SqlConnection(connectionString); }))
        {
        }
    }
}
